...
<div class="row gray-section no-margin full-section">
    <div class="container">                
        ...
        <div class="col-md-6 full-img text-center" style="background-image: url({{ asset('asset/img/f.jpg') }});"> 
...
<div class="footer-city row no-margin" style="background-image: url({{ asset('asset/img/footer.jpg') }});"></div>-->
@endsection