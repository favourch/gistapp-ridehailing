...
class AccountController extends Controller
{
    ...
    /**
     * Update db with top up amount
     */
    public function profile_topup(Request $request)
    {
        ...
        try{
            $account = Auth::guard('account')->user();
            $account->wallet_balance = $request->wallet_balance;
            $account->save();

            return redirect()->back()->with('flash_success','Top Up successful');
        }
